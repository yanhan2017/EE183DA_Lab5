function path = findpath(maxX,maxY,Xtarget,Ytarget,Xinitial,Yinitial,obs)
...
xTarget=Xtarget;%X Coordinate of the Target
yTarget=Ytarget;%Y Coordinate of the Target
...
xStart=Xinitial;%Starting Position
yStart=Yinitial;%Starting Position
MAP(xStart,yStart)=1;
